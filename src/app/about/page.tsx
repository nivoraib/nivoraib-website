    ...
    <div className="flex flex-col space-y-20 sm:space-y-24 py-12 sm:py-16">
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-8">
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-3 gap-4">
          <div className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-800 text-center">
            <Building2 className="w-5 h-5 text-brand-indigo dark:text-brand-lavender" />
            <span className="text-xs font-bold text-navy-900 dark:text-white">NivoraIB</span>
            <span className="text-[11px] text-slate-500 dark:text-slate-400">Company</span>
          </div>
          <div className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-800 text-center">
            <MapPin className="w-5 h-5 text-emerald-600 dark:text-emerald-400" />
            <span className="text-xs font-bold text-navy-900 dark:text-white">New Delhi, India</span>
          ...
          <div className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-800 text-center">
            ...
            <span className="text-xs font-bold text-navy-900 dark:text-white">2026</span>
            <span className="text-[11px] text-slate-500 dark:text-slate-400">Founded</span>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 space-y-8">
        <div className="prose prose-lg text-slate-700 dark:text-slate-200 leading-relaxed space-y-6">
          ...
          <div className="p-6 bg-slate-50 dark:bg-navy-900 rounded-2xl border border-slate-200/80 dark:border-navy-750 space-y-3 font-medium text-sm sm:text-base text-slate-800 dark:text-slate-200">
          ...
          <blockquote className="border-l-4 border-brand-indigo dark:border-brand-lavender pl-5 my-2 space-y-1">
            <p className="text-sm sm:text-base font-medium text-navy-900 dark:text-white italic leading-relaxed">
            ...
            <footer className="text-xs text-slate-500 dark:text-slate-400 not-italic">
      ...
      <section className="bg-slate-50 dark:bg-navy-900/50 py-16 sm:py-20 border-y border-slate-200/80 dark:border-navy-800">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-navy-750 p-8 space-y-4 shadow-sm">
              <div className="w-12 h-12 rounded-xl bg-brand-light dark:bg-brand-indigo/20 text-brand-dark dark:text-brand-light flex items-center justify-center font-bold">
                01
              </div>
            ...
            <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-navy-750 p-8 space-y-4 shadow-sm">
              <div className="w-12 h-12 rounded-xl bg-indigo-50 dark:bg-indigo-950/40 text-indigo-700 dark:text-brand-lavender flex items-center justify-center font-bold">
                03
              </div>
              <h3 className="text-xl font-bold text-navy-900 dark:text-white">
            ...
            <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-navy-750 p-8 space-y-4 shadow-sm">
              <div className="w-12 h-12 rounded-xl bg-purple-50 dark:bg-purple-950/40 text-purple-700 dark:text-purple-300 flex items-center justify-center font-bold">
                04
              </div>
              <h3 className="text-xl font-bold text-navy-900 dark:text-white">
      ...
      <section className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="p-6 sm:p-8 rounded-2xl border border-slate-200/90 dark:border-navy-750 bg-white dark:bg-navy-900 text-navy-900 dark:text-white space-y-4 shadow-card dark:shadow-xl">
          ...
          <div className="pt-2">
            <Link
              ...
              className="inline-flex items-center gap-1.5 text-xs font-bold text-brand-indigo hover:text-brand-purple dark:text-brand-lavender dark:hover:text-white transition-colors group"
            >
