  ...
  return (
    <div className="flex flex-col space-y-16 sm:space-y-20 py-12 sm:py-16">
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <SectionHeader
          badge="Knowledge Hub"
          title="Research Briefs, Reliability Notes &amp; IB Pedagogy"
          subtitle="Explore how we adapt long-horizon AI agent research to the high-stakes domain of the International Baccalaureate Diploma Programme."
        />
      </section>
