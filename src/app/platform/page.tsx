    ...
    <div className="flex flex-col space-y-20 sm:space-y-24 py-12 sm:py-16">
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-navy-750 p-8 space-y-4 shadow-sm hover:shadow-card transition-all">
            <div className="w-12 h-12 rounded-xl bg-brand-light dark:bg-brand-indigo/20 text-brand-dark dark:text-brand-light flex items-center justify-center border border-brand-soft/50 dark:border-brand-indigo/30 font-bold">
            ...
            <ul className="space-y-2 pt-3 border-t border-slate-100 dark:border-navy-800 text-xs text-slate-600 dark:text-slate-300">
          ...
          <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-navy-750 p-8 space-y-4 shadow-sm hover:shadow-card transition-all">
            <div className="w-12 h-12 rounded-xl bg-indigo-50 dark:bg-indigo-950/40 text-indigo-700 dark:text-brand-lavender flex items-center justify-center border border-indigo-200 dark:border-indigo-800/60 font-bold">
      ...
      <section id="context-layers" className="bg-slate-50 dark:bg-navy-900/50 py-16 sm:py-20 border-y border-slate-200/80 dark:border-navy-800">
      ...
      <section id="human-in-the-loop" className="bg-slate-50 dark:bg-navy-900 text-navy-900 dark:text-white py-16 sm:py-20 border-y border-slate-200/80 dark:border-navy-800/80 transition-colors">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="space-y-6">
              <span className="text-xs font-mono font-bold uppercase tracking-widest text-brand-dark dark:text-brand-lavender bg-brand-light/80 dark:bg-navy-800 px-3 py-1 rounded-full border border-brand-soft/60 dark:border-navy-700 inline-block">
                Teacher Decision Invariant
              </span>
              <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight leading-tight text-navy-900 dark:text-white">
              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">
                    <strong className="text-navy-900 dark:text-white font-semibold">Full In-Line Editing:</strong> Modify any lesson segment, prompt question, or mark allocation before approval.
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Share2 className="w-5 h-5 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
                  <div className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">
                    <strong className="text-navy-900 dark:text-white font-semibold">Frictionless Export:</strong> One-click output to Word, PDF, LMS platforms, or department course drives.
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <RefreshCw className="w-5 h-5 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
                  <div className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">
                    <strong className="text-navy-900 dark:text-white font-semibold">Reusable Departmental Memory:</strong> Validated units automatically update your school cohort history for future years.
                  </div>
                </div>
              </div>
            </div>

            <div className="bg-white dark:bg-navy-850 rounded-2xl border border-slate-200/90 dark:border-navy-700 p-6 sm:p-8 space-y-4 font-mono text-xs text-slate-700 dark:text-slate-300 shadow-card dark:shadow-2xl">
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-navy-700 pb-3">
                ...
                <span className="text-slate-500 dark:text-slate-400">Node: AuditComplete</span>
              </div>
              <div className="space-y-2 text-[11px] leading-relaxed">
                <p className="text-slate-500 dark:text-slate-400">// Stage 1 State Transition Rule</p>
                <p className="text-emerald-700 dark:text-emerald-300 font-medium">if (artifact.audit_report.passed === true) &#123;</p>
                <p className="pl-4 text-navy-900 dark:text-white font-semibold">state = &quot;TEACHER_REVIEW&quot;;</p>
                <p className="pl-4 text-slate-500 dark:text-slate-400">// Strict constraint: No direct publish without teacher review token</p>
                ...
                <p className="pl-4 text-slate-500 dark:text-slate-400">flag_pedagogical_omissions(artifact.audit_report.failures);</p>
                <p className="text-emerald-700 dark:text-emerald-300 font-medium">&#125;</p>
              </div>
              <div className="p-3 rounded-lg bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-800 text-[11px] text-slate-600 dark:text-slate-400 font-sans">
