...
export const ROADMAP_DATA: RoadmapStage[] = [
  ...
  },
  {
    ...
    badgeColor: "bg-indigo-50 dark:bg-zinc-800 text-indigo-700 dark:text-zinc-200 border-indigo-200 dark:border-zinc-700",
  ...
  },
  {
    ...
    badgeColor: "bg-slate-100 dark:bg-zinc-800 text-slate-700 dark:text-zinc-300 border-slate-200 dark:border-zinc-700",
