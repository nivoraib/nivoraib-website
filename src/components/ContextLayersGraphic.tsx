  ...
  const layers = [
    {
      ...
      darkColor: "dark:bg-blue-950/30 dark:text-blue-300 dark:border-zinc-700",
    },
    {
      step: "02",
      ...
      darkColor: "dark:bg-indigo-950/30 dark:text-indigo-300 dark:border-zinc-700",
    },
    {
      step: "03",
      ...
      icon: School,
      lightColor: "bg-slate-100 text-slate-800 border-slate-200/80",
      darkColor: "dark:bg-zinc-800/80 dark:text-zinc-200 dark:border-zinc-700",
    },
    {
      step: "04",
      title: "Previous Work",
      ...
      darkColor: "dark:bg-amber-950/30 dark:text-amber-300 dark:border-zinc-700",
    },
    {
      step: "05",
      ...
      darkColor: "dark:bg-rose-950/30 dark:text-rose-300 dark:border-zinc-700",
    },
  ];
    ...
    <div className="w-full max-w-5xl mx-auto space-y-6">
      ...
      */}
      <div className="grid grid-cols-1 md:grid-cols-6 xl:grid-cols-5 gap-3.5">
        {layers.map((layer, index) => {
          ...
          return (
            <div
              key={layer.step}
              className={`${tabletSpan} p-4 sm:p-5 rounded-2xl border ${layer.lightColor} ${layer.darkColor} bg-white dark:bg-zinc-850 flex flex-col justify-between space-y-4 shadow-subtle hover:shadow-card transition-all group`}
            >
              ...
              <div>
                <h3 className="font-bold text-navy-900 dark:text-zinc-100 text-sm leading-snug">
                  {layer.title}
                </h3>
              ...
              <div className="pt-2 border-t border-slate-100 dark:border-zinc-800 flex items-center gap-1 text-[11px] font-semibold text-brand-dark dark:text-zinc-300">
      ...
      <div className="flex flex-col items-center justify-center py-2 text-slate-400">
        <div className="flex items-center gap-2 text-xs font-mono font-bold uppercase tracking-wider text-slate-600 dark:text-zinc-300 bg-slate-100/90 dark:bg-zinc-850 px-4 py-1.5 rounded-full border border-slate-200/80 dark:border-zinc-700 shadow-2xs">
          <span>5 Scoped Context Streams Converge</span>
          <ArrowDown className="w-3.5 h-3.5 text-brand-indigo dark:text-zinc-300" />
        </div>
      </div>

      {/* Grounded AI Output Result Box */}
      <div className="rounded-2xl border border-emerald-300/80 dark:border-emerald-800/60 bg-emerald-50/40 dark:bg-emerald-950/20 p-6 sm:p-8 shadow-sm">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-start sm:items-center gap-4">
            ...
            <div className="space-y-1">
              ...
              <h3 className="text-lg sm:text-xl font-extrabold text-navy-900 dark:text-zinc-100">
          ...
          <div className="shrink-0 flex items-center gap-2">
            <span className="text-xs font-bold text-emerald-900 dark:text-emerald-300 bg-white dark:bg-zinc-850 px-3.5 py-2 rounded-xl border border-emerald-200 dark:border-emerald-800 shadow-2xs">
