...
export default function CareerCard({ role }: { role: CareerRole }) {
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-navy-800 hover:border-slate-300 dark:hover:border-navy-600 bg-white dark:bg-navy-900 p-6 shadow-sm hover:shadow-card hover:-translate-y-1 transition-all duration-200 flex flex-col justify-between space-y-6 group">
      <div className="space-y-4">
        <div>
          ...
          <h3 className="text-xl font-extrabold text-navy-900 dark:text-white mt-2 group-hover:text-brand-indigo dark:group-hover:text-brand-lavender transition-colors">
            {role.title}
          </h3>
      ...
      <div className="pt-3 border-t border-slate-100 dark:border-navy-800 flex items-center justify-end">
        <Link
          ...
          className="inline-flex items-center gap-1 text-xs font-bold text-brand-dark dark:text-brand-lavender hover:text-brand-indigo dark:hover:text-white transition-colors group-hover:translate-x-0.5"
        >
