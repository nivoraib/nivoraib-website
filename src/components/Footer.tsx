...
export default function Footer() {
  return (
    <footer className="bg-slate-50 dark:bg-navy-950 text-slate-600 dark:text-slate-300 pt-16 pb-12 border-t border-slate-200 dark:border-navy-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-200 dark:border-slate-800/80">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-10 h-10 shrink-0 bg-white dark:bg-white/95 rounded-lg p-0.5 border border-slate-200/80 dark:border-slate-700/80 shadow-2xs">
                <Image
              ...
              <div className="flex flex-col">
                <span className="font-extrabold text-2xl tracking-tight text-navy-900 dark:text-white group-hover:text-brand-indigo dark:group-hover:text-brand-lavender transition-colors duration-150">
                  Nivoraib
                </span>
                <span className="text-xs text-brand-indigo dark:text-brand-lavender font-medium">
            ...
            <div className="p-3.5 rounded-xl bg-white dark:bg-navy-900 border border-slate-200 dark:border-slate-800 shadow-2xs flex items-start gap-3">
          ...
          <div className="space-y-3">
            <div className="text-xs font-bold uppercase tracking-wider text-navy-900 dark:text-white">
              Platform &amp; Workflows
            </div>
              ...
              {FOOTER_NAV.product.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    prefetch={false}
                    className="text-slate-600 dark:text-slate-400 hover:text-navy-900 dark:hover:text-white transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="pt-8 space-y-4 text-xs text-slate-500 dark:text-slate-400">
          <p className="leading-relaxed">
            <strong className="text-slate-700 dark:text-slate-300">Disclaimer:</strong> Nivoraib is an independent educational technology startup. International Baccalaureate® and IB® are registered trademarks owned by the International Baccalaureate Organization. Nivoraib is not affiliated with, officially endorsed by, or sponsored by the International Baccalaureate Organization. All curriculum frameworks mentioned are for contextual grounding of teacher-owned academic workflows.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-slate-200 dark:border-slate-800/60 text-slate-500 dark:text-slate-400">
            <div>
